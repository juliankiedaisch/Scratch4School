...
const SET_CAN_SAVE = 'scratch-gui/project-state/SET_CAN_SAVE'; // Added for save functionality
...
const initialState = {
    ...
    canSave: false // Added canSave property with default false
};
...
const reducer = function (state, action) {
    ...
    switch (action.type) {
    case SET_CAN_SAVE: // Handle the SET_CAN_SAVE action
...
// Added action creator for setting canSave
const setCanSave = function (canSave) {
    return {
        type: SET_CAN_SAVE,
        canSave: canSave
    };
...
export {
    ...
    saveProjectAsCopy,
    setCanSave,  // Export the new action creator
    setProjectId
};