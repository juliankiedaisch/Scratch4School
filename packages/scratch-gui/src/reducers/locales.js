...
const mergeMessages = () => {
    const messagesByLocale = {...editorMessages};
    
    // If German translations exist in both sources, merge them
    if (messagesByLocale.de) {
        messagesByLocale.de = {
            ...messagesByLocale.de,
            ...customDeMessages
        };
    } else {
        messagesByLocale.de = customDeMessages;
    }
...
const initialState = {
    isRtl: false,
    locale: 'en',
    messagesByLocale: mergedMessages, // Use merged messages instead of original editorMessages
    messages: mergedMessages.en
};

// Rest of your reducer code remains the same
