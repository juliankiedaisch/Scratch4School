...
/**
 * Collaboration Projects Tab - Shows projects where user has write/admin permission but is not owner
 */
const CollaborationProjectsTab = ({
    projects,
    loading,
    error,
    selectedProject,
    ...
    // Note: This logic is duplicated in my-projects-tab.jsx
                ...
                {selectedProject && (
                    <>
                        ...
                        <div className={styles.projectInfoContainer}>
                                ...
                                <div className={styles.projectHeaderTitleContainer}>
                                    {!isEditingTitle ? (
                                        <>
                                            ...
                                            {/* Show edit button only for admins (user is not owner in this tab) */}
                            ...
                            {/* Submit to Assignment Button */}
                            {(selectedProject.permission === 'WRITE' || selectedProject.permission === 'ADMIN') && (
...
CollaborationProjectsTab.propTypes = {
...
export default CollaborationProjectsTab;
