...
const buildConfig = baseConfig.clone()
    ...
    .addPlugin(new HtmlWebpackPlugin({
        ...
        template: 'src/playground/index.ejs',
        title: 'Scratch4School GUI: Standalone Mode'
    }))
    .addPlugin(new HtmlWebpackPlugin({
        ...commonHtmlWebpackPluginOptions,
        chunks: ['blocksonly'],
        ...
        template: 'src/playground/index.ejs',
        title: 'Scratch4School GUI: Blocks Only Example'
    }))
    .addPlugin(new HtmlWebpackPlugin({
        ...commonHtmlWebpackPluginOptions,
        ...
        template: 'src/playground/index.ejs',
        title: 'Scratch4School GUI: Compatibility Testing'
    }))
    .addPlugin(new HtmlWebpackPlugin({
        ...commonHtmlWebpackPluginOptions,
        chunks: ['player'],
        ...
        template: 'src/playground/index.ejs',
        title: 'Scratch4School GUI: Player Example'
    }))
    .addPlugin(new CopyWebpackPlugin({
        patterns: [
            {
